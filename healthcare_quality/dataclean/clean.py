import pandas as pd
from dataclean.get import cahps_df, mua_df, readm_df
import dataclean.explore as explore
...
mua_cols_clean = explore.get_cols(mua_df_s)
mua_counts_clean = explore.get_counts(mua_df_s)
...
mua_df_clean=binarize_categorical_variable(mua_df_p, 'is-MUA?', ['Medically Underserved Area'])
